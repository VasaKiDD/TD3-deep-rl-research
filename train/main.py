...
from agent import DDPG, DDPG_curiosity, OurDDPG, TD3
...
if __name__ == "__main__":
    ...
    elif args.policy_name == "DDPG_curiosity":
        policy = DDPG_curiosity.DDPG(state_dim, action_dim, max_action)
    ...
    while total_timesteps < args.max_timesteps:
        ...
        if total_timesteps < args.start_timesteps:
            ...
            if args.expl_noise != 0:
                action = (
                    action + np.random.normal(0, args.expl_noise, size=env.action_space.shape[0])
